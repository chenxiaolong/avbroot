...
4. Пропатчите ОТА-архив с помощью команды:
    ...
    * Для получения root-доступа с использованием Magisk:
        ...
        Если вы хотите пропатчили загрузочный образ вручную через приложение Magisk (вместо идентичного автоматического патчинга через avbroot), используйте следующий аргумент:
